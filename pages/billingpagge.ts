...
//   //    private readonly voucherMenu: Locator;
...
//   //   this.voucherMenu=this.leftFrame.locator("//a[text()='Vouchers']");
...
//   // }
//   // async navigateToVoucher(): Promise<void> {
//   //   await this.billingMenu.click();
//   //   await this.invVoucherMenu.click();
//   //   await this.voucherMenu.click();
//   // }
